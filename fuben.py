...
response_1 = requests.get(url=url, headers=headers, proxies={"https://": ''},verify=False).text
...
for list in html_list:
    ...
    for data in img_data:
        ...
        img_down = requests.get(url=data, headers=headers, proxies={"https://": ''},verify=False).content
